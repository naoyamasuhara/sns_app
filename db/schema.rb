...
ActiveRecord::Schema.define(version: 2019_03_24_120355) do
  ...
  create_table "community_partcipants", force: :cascade do |t|
    t.integer "user_id", null: false
    t.integer "community_id", null: false
    t.boolean "admin", default: false, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["community_id"], name: "index_community_partcipants_on_community_id"
